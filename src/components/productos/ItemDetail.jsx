...
export function ItemDetail({ product, quantity, setQuantity }) {
  ...
  return (
    <section className=" bg-[#0f1419] py-15">
          ...
          <div className="space-y-6">
            ...
            <div className="border-t border-[#2f3847] pt-6">
              ...
              >
                {product.disponibilidad === 0
                  ? "Producto agotado"
                  : `${product.disponibilidad} unidades disponibles`}
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-6">
              <Link
                ...
                className="flex-1 bg-[#8ed1fc] text-[#0f1419] rounded-full px-8 py-3 font-semibold hover:bg-[#7bc3f0] transition flex items-center justify-center space-x-2 cursor-pointer"
              >
