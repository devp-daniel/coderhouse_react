        ...
        <div className="col-span-2">
          ...
          <div className="flex gap-4">
            <a
              ...
              target="_blank"
              className="w-10 h-10 flex items-center justify-center rounded-full border border-[#404a5a] hover:bg-gradient-to-r hover:from-[#ff6b35] hover:to-[#ff8e9b] transition"
            >
